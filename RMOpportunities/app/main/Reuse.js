            ...
            <View style={styles.header} >
               <LinearGradient
                  ...
                  <View style={styles.headerIcon}>
                     <Image source={require('../img/smartphone.png')} style = {styles.logoLeft} />
                  </View>
                  <Text style={styles.title}>
                     {Translation[lang].reuse_title}
                  </Text>
                  <View style={styles.headerIcon}>
                     <Image source={require('../img/earth.png')} style = {styles.logoRight} />
                  </View>
               </LinearGradient>
            </View>
            <ScrollView>
                           ...
                           return(
                              <View style={styles.containerMain}>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step1_1}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step1_2}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step1_3}
                                 </Text>
                              </View>
                           );
                        }
                     ...
                     {(() =>{
                        if(step2 === 'true'){
                           return(
                              <View style={styles.containerMain}>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step2_1}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step2_2}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step2_3}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step2_4}
                                 </Text>
                              </View>
                           );
                        }
                     ...
                     {(() =>{
                        if(step3 === 'true'){
                           return(
                              <View style={styles.containerMain}>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step3_1}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step3_2}
                                 </Text>
                                 <Text style={styles.instructions}>
                                    {Translation[lang].reuse_step3_3}
                                 </Text>
                              </View>
                           );
                        }
