                ...
                if (step1){
                    ...
                    <View>
                        ...
                        <View style={{alignItems:'center'}}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                <TextInput style={[styles.textToFill, {width:width*0.4}]} underlineColorAndroid={'transparent'} placeholder={Trad[lang].nom_douane} onChangeText={(nomenc) => this.setState({nomenc})} value={this.state.nomenc}/>
                                <Picker style={[styles.textToFill, {width:width*0.35, marginLeft:width*0.05}]} selectedValue={selected_cat} onValueChange={this.onCatChange.bind(this,'value')}> 
                    ...
                    <View>
                        ...
                        <View style={{alignItems:'center'}}>
                            ...
                            <View>
                                <TextInput style={styles.textToFill} underlineColorAndroid={'transparent'} placeholder={Trad[lang].cont_prod + star} onChangeText={(contenant) => this.setState({contenant})} value={this.state.contenant}/>
                            </View>
                            <View>
